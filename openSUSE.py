...
def check_it():
    checkURL = "http://mirrors.zju.edu.cn/opensuse/update/"
    line_regex = re.compile('<a href="openSUSE-current/">openSUSE-current/</a>.*')
    ...
    with urllib.request.urlopen(checkURL) as response:
        ...
        return compare.compare(timestamp, 3600 * 24 * 3)
